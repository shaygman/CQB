//==================================================================CQB_fnc_interactProgress===============================================================================================
// Create a progress bar and anim for the player
// Example: [_text,_time] call CQB_fnc_interactProgress;
//==================================================================================================================================================================================
...
(["CQB_interactionPB"] call BIS_fnc_rscLayer) cutRsc ["CQB_interactionPB", "PLAIN"];
_ctrl = ((uiNamespace getVariable "CQB_interactionPB") displayCtrl 2);
_ctrl ctrlSetText _text;
_ctrl = ((uiNamespace getVariable "CQB_interactionPB") displayCtrl 1);
...
(["CQB_interactionPB"] call BIS_fnc_rscLayer) cutText ["", "PLAIN"];
