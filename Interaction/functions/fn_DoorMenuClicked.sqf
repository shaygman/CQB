//=========================================================CQB_fnc_DoorMenuClicked==========================================================================================
//==============================================================================================================================================================================
private ["_ctrl","_index","_ctrlData","_object","_animation","_phase","_door","_addIndex"];
...
switch (_ctrlData) do
{
	case "charge":
	{
		...
		player removeMagazine CQB_CHARGE;
		["Placing Charge",4] call CQB_fnc_interactProgress;
	...
	case "camera":
	{
		...
		closedialog 0;
		player setVariable ["CQB_mirrorCamOff",false];
		...
		player setVariable ["CQB_doorCam",_camera];


		_keyDown = (findDisplay 46) displayAddEventHandler  ["KeyDown", "if !(isnil 'CQB_fnc_DOOR_CAM_Handler') then {CQB_temp = ['keydown',_this,commandingmenu] spawn CQB_fnc_DOOR_CAM_Handler; CQB_temp = nil;}"];

		//CLose cam
		while {!(player getVariable ["CQB_mirrorCamOff",false]) && (alive player)} do
		{
	...
	{
		closedialog 0;
		["Unlocking",15] call CQB_fnc_interactProgress;
	...
	{
		closedialog 0;
		["Locking",15] call CQB_fnc_interactProgress;
